...
<head>
  <title>Watsons - Tạo tài khoản</title>
...
<body style="min-height: calc(100vh - 500px);">
  ...
  <div class="container container_s register-form">
    ...
    <form class="row" action="" method="POST" style="margin-top: 10px">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          <label for="City"><strong>Tỉnh</strong></label>
          <input type="text" id="City" class="form-control City" placeholder="Nhập tỉnh">
        ...
        <div class="form-group">
          <label for="Province"><strong>Thành Phố / Quận / Huyện</strong></label>
          <input type="text" id="Province" class="form-control Province" placeholder="Nhập thành phố/ quận/ huyện">
          <div class="ProvinceError invalid-feedback">
            Chưa nhập thành Thành Phố / Quận / Huyện!
          </div>
        </div>
