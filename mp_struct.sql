...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2021 at 06:44 AM
...
ALTER TABLE `mp_order_detail`
  ...
  ADD CONSTRAINT `mp_order_detail_ibfk_3` FOREIGN KEY (`id_warehouse`) REFERENCES `mp_warehouse` (`id`);
...
--
-- Constraints for table `mp_type_product`
--
ALTER TABLE `mp_type_product`
  ADD CONSTRAINT `mp_type_product_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `mp_category` (`id`);
